        ...
        <div class="row px-1">
            <div class="col-md-10">
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        {
                            search_product(); // Display all products
                        }
                    ?>
                    <!-- row end -->
                </div>
            ...
            <div class="col-md-2 bg-secondary p-0">
                ...
                <ul class="shadow-lg rounded navbar-nav bg-secondary text-center m-4">
                    <li class="nav-item rounded bg-success">
                        <a href="" class="nav-link rounded text-light"><h4>Brands</h4></a>
                    </li>
                    <?php
                        //calling function
                        get_brands();
                ...
                <ul class="shadow-lg rounded navbar-nav bg-secondary text-center m-4">
                    <li class="nav-item rounded bg-success">
                        <a href="" class="nav-link rounded text-light"><h4>Categories</h4></a>
                    </li>
                    <?php
                        //calling function
                        get_categories();
