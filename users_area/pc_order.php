<html>
    ...
    <meta charset="UTF-8">
        ...
        <title>Ecommerce Website-PC Cart Details</title>
        <!-- sweet alert js link -->
    ...
    <body>
        <?php
            ...
            $total_price = 0;
            $cart_query_price = "SELECT products.product_id, products.product_discount, pc_cart.quantity 
                                FROM pc_cart 
            ...
            while($row_fetch = mysqli_fetch_array($result))
            {
                ...
                $insert_pending_orders = "INSERT INTO orders_pending (user_id, invoice_number, product_id, quantity, order_status, code) 
                            VALUES ($user_id, $invoice_number, '$product_id', '$quantity', '$status', 'special')";
            ...
            $insert_orders = "INSERT INTO user_orders (user_id, amount_due, invoice_number, total_products, order_date, order_status, code, payment_status) 
                            VALUES ($user_id, $total_price, $invoice_number, $count_products, NOW(), '$status', 'special', 'Unpaid')";
            ...
            $empty_cart = "DELETE FROM pc_cart WHERE user_id='$user_id'";
