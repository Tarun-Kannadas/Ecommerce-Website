...
if(isset($_POST['user_login']))
{
    ...
    if($row_count>0)
    {
        ...
        {
            echo 'invalid'; // Send invalid credentials message
            exit();
        }
    }
    else
            ...
            <div class="registration col-4 my-4">
                <form id="loginForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="text-center mt-44 pt-2">
                        ...
                        <p class = "medium fw-bold mt-3 pt-2 mb-0">Don't Have An Account ?
                        <a href="user_registration.php" class="text-success"> Register Now!</a></p>
                        <p class="medium fw-bold mt-3 pt-2 mb-0">Check out us as a Guest ->
                        <a href="../index.php" class="text-success"> Guest Mode</a></p>
                    </div>
                </form>
            </div>
        </div>
